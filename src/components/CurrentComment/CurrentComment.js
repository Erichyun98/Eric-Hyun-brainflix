...
//                         <p className='currrent-comment__name'>{comment.name}</p>  
//                     </div>
//                     <div className='current-comment__date-holder'>
//                         <p className='current-comment__date'>{comment.timestamp}</p>
//                     </div>
//                     <p className='current-comment__comment'>{comment.comment}</p>
//                 </div>
//         </section>
//     )
// }
